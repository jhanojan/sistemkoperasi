				...
				<tr>
					...
					<td>
						...
						<div class="clearfix">
							...
							<?php 
								$nm_f = "item";
								echo form_input($nm_f, isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required]' readonly");
							?>
						</div><div class="clearfix">
							<label class="title">Kas</label>
							<?php 
								$nm_f = "kas";
								echo form_dropdown($nm_f, $isi_kas,isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required,custom[number]]'");
							?>
						</div>
