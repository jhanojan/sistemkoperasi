...
<div id="block_add_edit">
	...
	<form id="form_edit" action="<?php echo base_url().$filename;?>/update" method="post" enctype="multipart/form-data">
		...
		<fieldset>
				...
				<tr>
					...
					<td>
						...
						$kodkop=$this->db->select('kode')->from('tb_kode_koperasi')->get()->row_array();
								echo form_hidden('kodkop',$kodkop['kode'],"class='validate[required]'  disabled");
							?>
                        <div class="clearfix">
							<label class="title">NIK</label>
							<?php 
								$nm_f = "nik";
								echo form_input($nm_f, isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required]'  disabled");
							?>
						</div>    
						<div class="clearfix">
						...
						<div class="clearfix">
							...
							<?php 
								$nm_f = "kode_jabatan";
								echo form_dropdown($nm_f, GetOptAllYes('tb_jabatan','- Jabatan -') ,isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required]'  disabled");
                        ...
                        <div class="clearfix">
							...
							<?php 
								$nm_f = "kelamin";
								echo form_dropdown($nm_f,array('L'=>'Laki-Laki','P'=>'Perempuan'), isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required]'  disabled");
								echo form_hidden($nm_f."_temp", isset($val[$nm_f]) ? $val[$nm_f] : "");
							?>
						</div>
                        <div class="clearfix">
                        ...
                        <div class="clearfix">
							...
							<?php 
								$nm_f = "tgl_lahir";
								echo form_input($nm_f, isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required,custom[date]]' disabled");
								echo form_hidden($nm_f."_temp", isset($val[$nm_f]) ? $val[$nm_f] : "");
							?>
						</div>
                        <div class="clearfix">
							...
							<?php 
								$nm_f = "agama";
								echo form_dropdown($nm_f,array(''=>'-Agama-','I'=>'Islam','P'=>'Protestan','K'=>'Katolik','H'=>'Hindu','B'=>'Budha'), isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required]'  disabled");
								echo form_hidden($nm_f."_temp", isset($val[$nm_f]) ? $val[$nm_f] : "");
							?>
						</div>
                        <div class="clearfix">
							...
							<?php 
								$nm_f = "alamat";
								echo form_textarea($nm_f, isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required]'  disabled");
								echo form_hidden($nm_f."_temp", isset($val[$nm_f]) ? $val[$nm_f] : "");
							?>
                        ...
                        <div class="clearfix">
							...
							<?php 
								$nm_f = "status";
								echo form_dropdown($nm_f,array('y'=>'Aktif','n'=>'Tidak Aktif'), isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required]'  disabled");
								echo form_hidden($nm_f."_temp", isset($val[$nm_f]) ? $val[$nm_f] : "");
							?>
						</div>
	    	...
	    	<input type="submit" name="back" value="Apply" class="btn" disabled>&nbsp;&nbsp;&nbsp;
