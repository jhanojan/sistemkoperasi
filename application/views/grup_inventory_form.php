			...
			<table id="tb_form_edit">
				...
				<tr>
					...
					<td>
                        ...
                        <div class="clearfix">
							<label class="title">Kode Grup Parent</label>
							<?php 
								$nm_f = "kode_group_parent";
								echo form_dropdown($nm_f,$grup_parent, isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='validate[required]'");
							?>
						</div>
						...
						<div class="clearfix">
							...
							<?php 
								$nm_f = "status";
								echo form_dropdown($nm_f, array('y'=>'Active','n'=>'InActive'),isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='span3 validate[required]'");
								echo form_hidden($nm_f."_temp", isset($val[$nm_f]) ? $val[$nm_f] : "");
							?>
						</div>
					</td>
