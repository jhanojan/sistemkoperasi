		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-setting-pos" data-widget-editbutton="false">
				...
				<div>
                    ...
                    <form id="form_edit" action="<?php echo site_url('buyout')?>/update" method="post" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                <section class="col-sm-5">
									<label class="input">
                                        <i class="icon-append fa fa-plus-square">Kode Barang </i>
									</label><input type="text" id="kodeBar" placeholder="< Kode Barang Disini"/><br>
                                </section>
                                <section class="col-sm-5">
									<label class="input">
                                        <i class="icon-append fa fa-plus-square">Supplier </i>
									</label>
                                <?php echo form_dropdown('supplier',$supplier,'')?>
                                </section>
                            </fieldset>
                            <fieldset>
...
$(document).off('keyup','#harga_dasar-<?php echo $a?>').on('keyup','#harga_dasar-<?php echo $a?>',function(e){
	var harga=parseInt($(this).val())*parseFloat($('#qty-<?php echo $a?>').val());
	//alert(harga);
	$('#total_price_<?php echo $a?>').val(harga);
});
<?php }?>
...
$("#kodeBar").delay(10000).keyup(function(){
	...
	$.get('<?php echo site_url('load')?>/muatbarang_beli/'+ $("#kodeBar").val()+'/'+i, function(result) {
