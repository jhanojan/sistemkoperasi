			...
			<table id="tb_form_edit">
				...
				<tr>
					...
					<td>
						...
						<div class="clearfix">
							<label class="title">Kode Jabatan</label>
							<?php 
								$nm_f = "kode_jabatan";
...
*/
						...
						<div class="clearfix">
							<label class="title">Nama Jabatan</label>
							<?php 
								$nm_f = "nama";
							...
							<?php 
								$nm_f = "status";
								echo form_dropdown($nm_f,array('y'=>'Aktif','n'=>'Tidak Aktif'), isset($val[$nm_f]) ? $val[$nm_f] : "", "id='".$nm_f."' class='span3 validate[required]'");
								echo form_hidden($nm_f."_temp", isset($val[$nm_f]) ? $val[$nm_f] : "");
							?>
						</div>
					</td>
