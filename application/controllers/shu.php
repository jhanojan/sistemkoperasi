...
{	
	...
	var $tabel = "tb_shu";
	var $id_primary = "id";
	var $title = "List Sisa Hasil Usaha";
	...
	function detail($id=null){
		...
		$data['opt_user']=GetOptAllYesCuss('tb_user','id','username','-User-');
	...
	function update()
	{
		...
		$data['id_jabatan']=GetValue('jabatan','user',array('id'=>'where/'.$data['id_user']));
	...
	function get_column(){
            ...
            $colModel['tanggal'] = array('Tanggal',50,TRUE,'left',2);
            $colModel['id_user'] = array('User',100,TRUE,'left',2);
            $colModel['id_jabatan'] = array('Jabatan',100,TRUE,'left',2);
            $colModel['persen'] = array('Persen',100,TRUE,'left',2);
	...
	function get_record(){
            ...
            $valid_fields = array('id','tanggal','id_user','id_jabatan','persen');
