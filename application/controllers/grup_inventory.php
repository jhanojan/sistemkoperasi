...
class Grup_inventory extends CI_Controller 
{	
	var $filename = "grup_inventory";
	var $tabel = "tb_group_inventory";
	var $id_primary = "id";
	var $title = "List Grup Inventory";
	...
	function detail($id=null){
		...
		$opt=GetOptAllYesCus('group_inventory','kode_group','-Parent-');
		$opt['none']='Tidak Ada Parent';
	...
	function get_column(){
            ...
            $colModel['kode_group_parent'] = array('Kode Grup Parent',100,TRUE,'left',2);
	...
	function get_record(){
            ...
            $valid_fields = array('id','kode_group','kode_group_parent','nama','status');
