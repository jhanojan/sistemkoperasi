...
{	
	var $filename = "jabatan";
	var $tabel = "tb_jabatan";
	var $id_primary = "id";
	var $title = "List Jabatan";
	...
	function get_column(){
            ...
            $colModel['kode_jabatan'] = array('Kode Jabatan',100,TRUE,'left',2);
            $colModel['nama'] = array('Nama Jabatan',200,TRUE,'left',2);
	...
	function get_record(){
            ...
            $valid_fields = array('id','kode_jabatan','nama','status');
